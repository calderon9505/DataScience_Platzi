...
SELECT * FROM PRODUCTOS WHERE PAISDEORIGEN != 'ESPANA' LIMIT 10;
...
SELECT CODIGOCLIENTE, FORMADEPAGO, COUNT(*) FROM PEDIDOS GROUP BY CODIGOCLIENTE, FORMADEPAGO ORDER BY CODIGOCLIENTE;
-- HAVING: sustituo del WHERE en consultas de agrupación
-- el where se ejecuta antes de los cálculos, el having despues.
-- el where filtra antes de agrupar, el having despues.
