...
# py main.py --n-palabras 500 --entrada el_quijote.txt --salida output.csa el_quijote.txt --salida output.csv
...
# para leer argumentos de entrada desde la linea de comandos
import argparse
...
def main():
  ...
  # distinguir los argumentos de python y los de apache beam
...
def run_pipeline(custom_args, beam_args):
  ...
  with beam.Pipeline(options=opts) as p:
    ...
    # Partir cada linea en sus palabras
    # Map devuelve una lista, FlatMap quita esa lista y devuelve cada string por aparte
